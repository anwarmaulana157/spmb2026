...
<body class="h-full bg-slate-50 overflow-auto">
  <div class="w-full min-h-full">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 md:h-20">
          ...
          <!-- Logo SVG -->
            ...
            <div class="block">
              <h1 id="school-name-header"  class="text-lg md:text-xl font-bold text-white whitespace-nowrap overflow-hidden text-ellipsis max-w-[180px] md:max-w-none">SMK Informatika Sumedang</h1>
          ...
          <!-- Mobile Menu Button --> 
          <button id="mobile-menu-btn" class="lg:hidden p-2 text-slate-300 hover:text-white">
    ...
    <!-- Hero Section -->
    <section id="beranda" class="relative min-h-screen pt-20 md:pt-24 overflow-hidden">
      ...
      <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 min-h-screen flex items-center">
        <div class="w-full">
          <div class="max-w-3xl">
            ...
            <span id="hero-title">Penerimaan Murid Baru</span> <br><span class="gradient-text">Tahun Pelajaran 2026/2027</span></h1>
    ...
    <section id="jurusan" class="py-20 bg-slate-50">
     ...
     <!-- Alur Pendaftaran Section -->
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Header -->
        <div class="text-center mb-12">
          <span class="inline-block px-4 py-1.5 bg-amber-100 text-amber-600 rounded-full text-sm font-semibold mb-4">
            Langkah Mudah
          </span>
          ...
          <p class="text-slate-600 max-w-2xl mx-auto">
            Proses pendaftaran yang simpel dan terstruktur untuk kemudahan calon murid baru
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          ...
          <!-- STEP 1 -->
          <div class="card-hover bg-gradient-to-br from-sky-50 to-cyan-50 rounded-2xl p-6 border-2 border-sky-200">
            <div class="w-12 h-12 bg-sky-600 text-white rounded-xl flex items-center justify-center font-bold mb-4">
              1
            </div>
            <h3 class="font-bold text-slate-900 mb-2">Daftar Online</h3>
            <p class="text-slate-600 text-sm">
              Isi formulir pendaftaran melalui website resmi SPMB.
            </p>
          </div>

          <!-- STEP 2 -->
          <div class="card-hover bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border-2 border-blue-200">
            <div class="w-12 h-12 bg-blue-600 text-white rounded-xl flex items-center justify-center font-bold mb-4">
              2
            </div>
            <h3 class="font-bold text-slate-900 mb-2">Upload Berkas</h3>
            <p class="text-slate-600 text-sm">
          ...
          <!-- STEP 3 -->
          <div class="card-hover bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border-2 border-emerald-200">
            <div class="w-12 h-12 bg-emerald-600 text-white rounded-xl flex items-center justify-center font-bold mb-4">
              3
            </div>
          ...
          <!-- STEP 4 -->
          <div class="card-hover bg-gradient-to-br from-purple-50 to-fuchsia-50 rounded-2xl p-6 border-2 border-purple-200">
            <div class="w-12 h-12 bg-purple-600 text-white rounded-xl flex items-center justify-center font-bold mb-4">
              4
            </div>
            <h3 class="font-bold text-slate-900 mb-2">Seleksi</h3>
            <p class="text-slate-600 text-sm">
              Mengikuti tes atau seleksi sesuai jalur pendaftaran.
            </p>
          </div>

          <!-- STEP 5 -->
          <div class="card-hover bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl p-6 border-2 border-amber-200">
            <div class="w-12 h-12 bg-amber-600 text-white rounded-xl flex items-center justify-center font-bold mb-4">
              5
            </div>
            <h3 class="font-bold text-slate-900 mb-2">Pengumuman</h3>
            <p class="text-slate-600 text-sm">
      ...
      <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- FAQ 1 -->
          ...
          <div class="faq-item bg-white rounded-2xl border border-slate-200 overflow-hidden"><button class="faq-btn w-full px-6 py-5 text-left flex items-center justify-between hover:bg-slate-50 transition-colors"> <span class="font-semibold text-slate-900">Berapa kuota yang tersedia untuk setiap jurusan?</span>
            ...
            <div class="faq-content hidden px-6 pb-5">
              <p class="text-slate-600">Kuota penerimaan murid baru SMK Informatika Sumedang terdiri dari 360 orang untuk jurusan Rekayasa Perangkat Lunak (RPL), 108 orang untuk Desain Komunikasi Visual (DKV), 36 orang untuk Axioo Class Program, dan 36 orang untuk Kelas Telkom.</p>
            </div>
          </div>
          ...
          <div class="faq-item bg-white rounded-2xl border border-slate-200 overflow-hidden"><button class="faq-btn w-full px-6 py-5 text-left flex items-center justify-between hover:bg-slate-50 transition-colors"> <span class="font-semibold text-slate-900">Apakah ada program beasiswa?</span>
            ...
            <div class="faq-content hidden px-6 pb-5">
              <p class="text-slate-600">Program beasiswa SMK Informatika Sumedang diberikan kepada murid yang diterima melalui jalur prestasi ataupun siswa yang berprestasi selama melaksanakan pembelajaran di SMK Informatika Sumedang baik berprestasi secara akademik dan/atau nonakademik.</p>
            </div>
          </div>
          ...
          <div class="faq-item bg-white rounded-2xl border border-slate-200 overflow-hidden"><button class="faq-btn w-full px-6 py-5 text-left flex items-center justify-between hover:bg-slate-50 transition-colors"> <span class="font-semibold text-slate-900">Apakah biaya pendidikan di SMK Informatika Sumedang terjangkau?</span>
            ...
            <div class="faq-content hidden px-6 pb-5">
              <p class="text-slate-600">Biaya pendidikan di SMK Informatika Sumedang dirancang agar terjangkau bagi berbagai lapisan masyarakat. Selain itu, tersedia program beasiswa prestasi bagi  yang memenuhi kriteria, sehingga dapat membantu meringankan beban biaya pendidikan.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="daftar" class="py-20 gradient-hero relative overflow-hidden">
      ...
      <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-slate-300 mb-10 max-w-2xl mx-auto">
          Wujudkan impianmu menjadi ahli teknologi dan desain bersama 
        ...
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a 
            href="login" 
            class="group px-10 py-5 bg-white text-slate-900 font-bold text-lg rounded-full 
                  hover:bg-slate-100 transition-all shadow-xl 
          ...
          <!-- Button WhatsApp -->
          <a 
            href="https://wa.me/6281321093109" 
            target="_blank" 
            rel="noopener noreferrer" 
            class="px-10 py-5 bg-emerald-500 text-white font-bold text-lg rounded-full 
